    ...
    <div className="flex flex-col items-start mr-8">
      ...
      <div className="flex flex-col space-y-4">
        <button
          ...
          className={`${activeTab === "viewProfile"
        ...
        <button
          ...
          className={`${activeTab === "uploadDocuments"
              ? "bg-purple-500 text-white"
              : "bg-gray-200 text-gray-600"
            } px-6 py-3 rounded-md focus:outline-none hover:bg-purple-800 hover:text-white transition duration-300`}
        >
        ...
        <button
          ...
          className={`${activeTab === "browseDoctors"
              ? "bg-purple-500 text-white"
              : "bg-gray-200 text-gray-600"
            } px-6 py-3 rounded-md focus:outline-none hover:bg-purple-800 hover:text-white transition duration-300`}
        >
        ...
        <button
          ...
          className={`${activeTab === "takeAdmission"
              ? "bg-purple-500 text-white"
              : "bg-gray-200 text-gray-600"
            } px-6 py-3 rounded-md focus:outline-none hover:bg-purple-800 hover:text-white transition duration-300`}
        >
        ...
        <button
          ...
          className={`${activeTab === "editAccount"
              ? "bg-purple-500 text-white"
              : "bg-gray-200 text-gray-600"
            } px-6 py-3 rounded-md focus:outline-none hover:bg-purple-800 hover:text-white transition duration-300`}
        >
        ...
        <button
          ...
          className={`${activeTab === "viewAppointments"
            ? "bg-purple-500 text-white"
            : "bg-gray-200 text-gray-600"
            } px-6 py-3 rounded-md focus:outline-none hover:bg-purple-800 hover:text-white transition duration-300`}
        >
